...
class Compose(Transaction):
    ...
    @classmethod
    def validate_compose(cls, inputs, recipients, asset_id, metadata):        
        ...
        ## TO VALIDATE
        # ASSERT NEW CREATION IN OUTPUT
        # ASSERT AMOUNT OF INPUT ASSETS IS LESS IN OUTPUT ASSETS USED
    ...
    def generate(cls, inputs, recipients, asset_id, metadata=None):
        ...
        """
        (inputs, outputs) = cls.validate_compose(inputs, recipients, asset_id, metadata)
